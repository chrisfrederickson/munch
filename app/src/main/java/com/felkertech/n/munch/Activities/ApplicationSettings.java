...
//    private static SharedPreferences sharedPreferences;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupActionBar();
        Log.d(TAG, "ApplicationSettings");
//        sharedPreferences = getApplication().getSharedPreferences(getString(R.string.PREFERENCES), MODE_PRIVATE);
    }
    ...
    private void setupActionBar() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
            ...
            try {
                ...
                Log.d(TAG, e.getMessage()+" < actionbar null");
            }
        }
    }
    ...
    private void setupSimplePreferencesScreen() {
        ...
        try {
            bindPreferenceSummaryToValue(findPreference("HUMIDL"));
            bindPreferenceSummaryToValue(findPreference("OZONE"));
            bindPreferenceSummaryToValue(findPreference("HUMIDH"));
        } catch(Exception e) {
